...
CONFIG_YAML = "configs/analysis_23_physics.yaml"
...
DATA_DIR = Path(
    "/eos/cms/store/group/dpg_bril/comm_bril/2023/raw/hfet/"
)
...
RESULT_DIR = Path(
    "/eos/cms/store/group/dpg_bril/comm_bril/2023/reprocessed/hfet/"
)
