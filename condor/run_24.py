...
CONFIG_YAML = "configs/analysis_24_physics.yaml"
...
DATA_DIR = Path(
    "/eos/cms/store/group/dpg_bril/comm_bril/2024/raw/hfet/"
)
...
RESULT_DIR = Path(
    "/eos/cms/store/group/dpg_bril/comm_bril/2024/reprocessed/hfet_v4/"
)
