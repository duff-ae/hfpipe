...
CONFIG_YAML = "configs/analysis_25_physics.yaml"
...
DATA_DIR = Path(
    "/eos/cms/store/group/dpg_bril/comm_bril/2025/raw/hfet/"
)
...
RESULT_DIR = Path(
    "/eos/cms/store/group/dpg_bril/comm_bril/2025/reprocessed/hfet/"
)
